...
{
    public static class MumbleOverlayGui
    {
        ...
        public static void DrawLine(Vector2 lineStart, Vector2 lineEnd, Color color, float thickness)
        {
        ...
        public static void DrawLineStretched(Vector2 lineStart, Vector2 lineEnd, Texture2D texture, float thickness)
        {
            ...
            GUI.DrawTexture(new Rect(lineStart.x, lineStart.y - yOffset, vector.magnitude, thickness), texture);
            GUIUtility.RotateAroundPivot(-pivot, lineStart);
        }
        ...
        public static void DrawLine(Vector2 lineStart, Vector2 lineEnd, Texture2D texture, float thickness)
        {
            ...
            var rect = new Rect(lineStart.x, lineStart.y - num2, Vector2.Distance(lineStart, lineEnd), thickness);
            GUIUtility.RotateAroundPivot(pivot, lineStart);
            GUI.BeginGroup(rect);
